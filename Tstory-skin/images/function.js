(function ($) {
    ...
    function toggleWidget() {
        $('.header').toggleClass('widget-on');
        // $('.btn_menu').toggleClass('btn_menu_off');
        if ($('.header').has('widget-on')) {
    ...
    function toggleMenu() {
        ...
        // $('.area_search').toggle();
        if ($('.header').has('menu-on')) {
            $('.header').removeClass('widget-on');
    ...
    $('body').bind('click', function (e) {
        var $target = $(e.target);
        if ($target.closest('.btn-toggle-widget').length > 0) {
            toggleWidget();
        } else if ($target.closest('.btn-toggle-menu').length > 0) {
            toggleMenu();
        }
    });
